...
#         Extract ONLY illustration blocks
#         """
#         pattern = r'(## ILLUSTRATION \d+\.\d+.*?)(?=## ILLUSTRATION \d+\.\d+|$)'
#         blocks = re.findall(pattern, text, re.S)
#         return blocks

#     def clean_block(self, block: str):
#         """
#         Keep only text AFTER heading and BEFORE 'Sol.'
#         """
#         # Remove heading
#         block = re.sub(r'## ILLUSTRATION \d+\.\d+', '', block).strip()
...
# def main():
#     md_text = load_markdown("output/sample.md")  # <-- your file

#     parser = IllustrationParser()

#     if parser.match(md_text):
#         questions = parser.parse(md_text)
#     else:
#         print("No matching parser found")
#         return
...
#     for q in questions:
#         print(q["question_id"])
#         print(q["raw"][:200])  # print first 200 chars (cleaner)
#         print("Images:", q["images"])
#         print("-----")
